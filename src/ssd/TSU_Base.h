...
protected:
	...
	bool independent_plane_read_enabled; //LM: This is a new parameter to enable/disable independent plane read
	...
	bool issue_command_to_chip(Flash_Transaction_Queue *sourceQueue1, Flash_Transaction_Queue *sourceQueue2, Transaction_Type transactionType, bool suspensionRequired, bool independent_plane_read_enabled);
