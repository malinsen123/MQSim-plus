...
namespace SSD_Components
{
	...
	//LM IMPORTANT: This function is called by the host interface to inform the data cache manager that a new user request is submitted to the SSD
	void Data_Cache_Manager_Flash_Advanced::process_new_user_request(User_Request* user_request)
	{
		...
		else//This is a write request
		{
			...
			//std::cout<<"Data_Cache_Manager_Flash_Advanced::process_new_user_request: write request"<<std::endl;
			...
			switch (caching_mode_per_input_stream[user_request->Stream_id])
			{
				case Caching_Mode::TURNED_OFF:
				case Caching_Mode::READ_CACHE:
					//std::cout<<"Data_Cache_Manager_Flash_Advanced::process_new_user_request: write request: case Caching_Mode::TURNED_OFF or Caching_Mode::READ_CACHE"<<std::endl;
					static_cast<FTL*>(nvm_firmware)->Address_Mapping_Unit->Translate_lpa_to_ppa_and_dispatch(user_request->Transaction_list);
					return;
				case Caching_Mode::WRITE_CACHE://The data cache manger unit performs like a destage buffer
				case Caching_Mode::WRITE_READ_CACHE:
				{
					//std::cout<<"Data_Cache_Manager_Flash_Advanced::process_new_user_request: write request: case Caching_Mode::WRITE_CACHE or Caching_Mode::WRITE_READ_CACHE"<<std::endl;
