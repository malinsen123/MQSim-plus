...
//LM: This function is called from the Host_Interface_NVMe class
inline void Input_Stream_Manager_NVMe::Submission_queue_tail_pointer_update(stream_id_type stream_id, uint16_t tail_pointer_value)
{
	...
	//std::cout<<"Submission tail pointer updated to "<<tail_pointer_value<<std::endl;
	//std::cout<<"Queue fetch size is "<<Queue_fetch_size<<std::endl;
	//std::cout<<"On the fly requests is ++"<<((Input_Stream_NVMe *)input_streams[stream_id])->On_the_fly_requests<<std::endl;

	//std::cout<<"the submission head is "<<((Input_Stream_NVMe *)input_streams[stream_id])->Submission_head<<std::endl;
	//std::cout<<"the submission tail is "<<((Input_Stream_NVMe *)input_streams[stream_id])->Submission_tail<<std::endl;
...
inline void Input_Stream_Manager_NVMe::Handle_new_arrived_request(User_Request *request)
{
	...
	//std::cout<<"the time is "<<Simulator->Time()<<std::endl;
	//std::cout<<"Handle new arrived request"<<std::endl;
...
inline void Input_Stream_Manager_NVMe::Handle_serviced_request(User_Request *request)
{
	...
	//std::cout<<"the time is "<<Simulator->Time()<<std::endl;
	//std::cout<<"Request ID "<<request->ID<<" is serviced"<<std::endl;
	//std::cout<<"on the fly requests is --"<<((Input_Stream_NVMe *)input_streams[stream_id])->On_the_fly_requests<<std::endl;
	...
	//std::cout<<"the submission head is "<<((Input_Stream_NVMe *)input_streams[stream_id])->Submission_head<<std::endl;
	//std::cout<<"the submission tail is "<<((Input_Stream_NVMe *)input_streams[stream_id])->Submission_tail<<std::endl;
	//std::cout<<"the completion head is "<<((Input_Stream_NVMe *)input_streams[stream_id])->Completion_head<<std::endl;
	//std::cout<<"the completion tail is "<<((Input_Stream_NVMe *)input_streams[stream_id])->Completion_tail<<std::endl;
...
void Request_Fetch_Unit_NVMe::Process_pcie_read_message(uint64_t address, void *payload, unsigned int payload_size)
{
	...
	case DMA_Req_Type::REQUEST_INFO:
	{
		...
		//std::cout<<"the time is "<<Simulator->Time()<<std::endl;
		//std::cout<<"Process pcie read message"<<std::endl;
		//std::cout<<"REQUEST_INFO"<<std::endl;
...
//LM
//for the write request, the data is sent to the host interface
void Request_Fetch_Unit_NVMe::Fetch_write_data(User_Request *request)
{
	...
	//std::cout<<"the time is "<<Simulator->Time()<<std::endl;
	//std::cout<<"Fetch write data"<<std::endl;
	//std::cout<<"size in byte is "<<request->Size_in_byte<<std::endl;
