...
public:
	...
	static bool SCA_Enabled;
	static bool Independent_Plane_Read_Enabled;
	static bool Two_Layer_ECC_Enabled;
	static double Two_Layer_ECC_512B_Failure_Rate;//The failure rate of 512B data in the first layer ECC
